...
see [hir(7)] (https://man.freebsd.org/cgi/man.cgi?query=hier&sektion=7&manpath=freebsd-release-ports)
...
1: Catalogue __CODESPAN_0_ Adds the schg permission, i.e. the system is immutable:
