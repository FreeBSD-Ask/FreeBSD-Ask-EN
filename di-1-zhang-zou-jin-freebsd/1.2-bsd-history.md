...
[image source: <https://github.com/freebsd/freebsd-src/blob/main/share/misc/bsd-family-tree>, with settlements] (./gitbook/assets/bsd-family-tree.png)
...
kqueue(2) is an innovative solution to replace select/poll and was introduced with FreeBSD 4.1-RELEASE on 27 July 2000. This extended event notification interface inspires Linux's Epoll() mechanism。
